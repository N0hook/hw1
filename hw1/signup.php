...
<span> Registrati al nostro sito per accedere alle funzionalità complete <br></br> </span>
...
<p><a href = "./home.php"> indietro </a></p>
...
<?php
 ...
 if(count($errore) != 0)
 {
    ...
    {
        echo "<span class='error'> $singolo_err </span></br>";
    }
